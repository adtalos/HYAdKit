...
#ifndef HYADKIT_SWIFT_H
#define HYADKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HYAdKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@protocol HYVideoListener;
@protocol HYListener;
enum HYLossReason : NSInteger;
SWIFT_CLASS_NAMED("BaseAd")
@interface HYBaseAd : NSObject
...
- (void)destroy;
@property (nonatomic, strong) id <HYVideoListener> _Nullable videoListener;
@property (nonatomic, strong) id <HYListener> _Nullable listener;
...
- (BOOL)sendLossNotice:(enum HYLossReason)lossReason;
...
@interface HYViewControllerAd : HYViewAd
...
typedef SWIFT_ENUM_NAMED(NSInteger, HYLossReason, "LossReason", open) {
  HYLossReasonBidPriceFilter = 1001,
  HYLossReasonPriceLowFilter = 1002,
  HYLossReasonAdmBlacklistFilter = 1003,
  HYLossReasonCompleteFilter = 1004,
  HYLossReasonTimeoutFilter = 1005,
  HYLossReasonOtherFilter = 1006,
};

@class HYNativeResponse;
SWIFT_CLASS_NAMED("NativeAd")
@interface HYNativeAd : HYBaseAd
@property (nonatomic, readonly, strong) HYNativeResponse * _Nullable nativeResponse;
- (nonnull instancetype)initWithUnitID:(NSString * _Nonnull)unitID OBJC_DESIGNATED_INITIALIZER;
- (void)destroy;
@end

@class UIImage;
@class HYVideoMetadata;
SWIFT_CLASS_NAMED("NativeResponse")
@interface HYNativeResponse : NSObject
- (void)destroy;
...
@property (nonatomic, readonly, strong) HYVideoMetadata * _Nullable videoMetadata;
- (void)videoPlay;
- (void)videoPause;
...
@interface HYRewardVideoAd : HYViewControllerAd
- (nonnull instancetype)initWithUnitID:(NSString * _Nonnull)unitID OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_PROTOCOL_NAMED("RewardVideoListener")
@protocol HYRewardVideoListener <HYListener>
@optional
- (void)onRewarded:(NSString * _Nonnull)data;
@end

SWIFT_CLASS_NAMED("SDK")
@interface HYSDK : NSObject
...
+ (void)initialize:(HYConfiguration * _Nonnull)config;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("SplashAd")
@interface HYSplashAd : HYViewControllerAd
- (nonnull instancetype)initWithUnitID:(NSString * _Nonnull)unitID OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_PROTOCOL_NAMED("VideoController")
@protocol HYVideoController
@property (nonatomic, strong) id <HYVideoListener> _Nullable videoListener;
@property (nonatomic, readonly) BOOL isPlaying;
@property (nonatomic, readonly) BOOL isEnded;
@property (nonatomic, readonly, strong) HYVideoMetadata * _Nullable metadata;
@property (nonatomic, readonly) BOOL hasVideo;
- (void)play;
- (void)pause;
- (void)mute:(BOOL)mute;
...
@protocol HYVideoListener <NSObject>
@optional
- (void)onVideoLoad:(HYVideoMetadata * _Nonnull)metadata;
- (void)onVideoStart;
- (void)onVideoPlay;
- (void)onVideoPause;
- (void)onVideoEnd;
...
enum HYPlayType : NSInteger;
enum HYStatus : NSInteger;
@class NSData;
SWIFT_CLASS_NAMED("VideoMetadata")
@interface HYVideoMetadata : NSObject
...
@property (nonatomic) enum HYPlayType type;
@property (nonatomic) enum HYStatus status;
...
typedef SWIFT_ENUM_NAMED(NSInteger, HYPlayType, "PlayType", open) {
  HYPlayTypeFirstPlay = 1,
  HYPlayTypeContinuePlay = 2,
  HYPlayTypeReplay = 3,
};

typedef SWIFT_ENUM_NAMED(NSInteger, HYStatus, "Status", open) {
  HYStatusNormal = 0,
  HYStatusLoading = 1,
  HYStatusError = 2,
};
